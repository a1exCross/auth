...
//go:generate minimock -i github.com/a1exCross/auth/internal/service.UserService -o user_service.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, up1 *model.UserCreate) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, up1 *model.UserCreate)
	...
	funcUpdate          func(ctx context.Context, up1 *model.UserUpdate) (err error)
	inspectFuncUpdate   func(ctx context.Context, up1 *model.UserUpdate)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, up1 *model.UserCreate) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, up1}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, up1 *model.UserCreate)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, up1 *model.UserCreate) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, up1 *model.UserCreate) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserServiceMockCreateParams{ctx, up1},
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, up1 *model.UserCreate) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateParams{ctx, up1}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, up1}
	...
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, up1)
	return
}
...
func (mmDelete *mUserServiceMockDelete) Expect(ctx context.Context, i1 int64) *mUserServiceMockDelete {
...
func (mmDelete *mUserServiceMockDelete) Inspect(f func(ctx context.Context, i1 int64)) *mUserServiceMockDelete {
...
func (mmDelete *mUserServiceMockDelete) Set(f func(ctx context.Context, i1 int64) (err error)) *UserServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mUserServiceMockDelete) When(ctx context.Context, i1 int64) *UserServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *UserServiceMock) Delete(ctx context.Context, i1 int64) (err error) {
...
func (mmGet *mUserServiceMockGet) Expect(ctx context.Context, i1 int64) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Inspect(f func(ctx context.Context, i1 int64)) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, i1 int64) (up1 *model.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserServiceMockGet) When(ctx context.Context, i1 int64) *UserServiceMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *UserServiceMock) Get(ctx context.Context, i1 int64) (up1 *model.User, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, up1 *model.UserUpdate) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, up1}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, up1 *model.UserUpdate)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, up1 *model.UserUpdate) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, up1 *model.UserUpdate) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, up1},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, up1 *model.UserUpdate) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, up1}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, up1}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, up1)
	return
}
